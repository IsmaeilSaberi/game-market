            ...
            <div className="flex flex-col gap-8">
              ...
              <section className="flex flex-col gap-6">
                ...
                <div className="flex justify-start items-center gap-2 text-base sm:text-sm flex-wrap">
                  <div className="bg-[#FFDE00] rounded-md p-2 flex justify-between items-center gap-2">
              ...
              <div className="flex justify-start items-center gap-2 flex-wrap">
                {data.tags.length < 1 ? (
                  ...
                  data.tags.map((ta, i) => (
                    <Link
                      key={i}
                      className=" p-2 flex justify-start items-center text-base sm:text-sm bg-[#FFDE00] hover:bg-zinc-300 transition-all duration-200 rounded-md"
