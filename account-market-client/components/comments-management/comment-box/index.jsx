...
const CommentBox = ({ data, commentProps }) => {
  ...
  return (
    <div className="relative bg-[#FFFAE7] border-2 border-zinc-400 p-2 rounded-md flex flex-col gap-2">
      <div className="flex justify-between items-center flex-wrap">
        <div className="bg-[#FFDE00] rounded px-2 py-1">{data.displayname}</div>
