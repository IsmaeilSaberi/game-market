        ...
        {data[0] == -1 ? (
          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between items-start gap-2">
              <div className="w-full rounded-md bg-[#FFFAE7] p-4">
                {data.length < 1 ? (
                  ...
                  <div className="w-full flex flex-col gap-8">
                    {data.map((da, i) => (
                      <div
                        className="w-full flex flex-col gap-4 bg-[#FFDE00] text-sm rounded-md p-4 border-2 border-indigo-400"
                        key={i}
                      >
              ...
              <div className="w-full md:w-80 flex flex-col gap-6 min-w-80 rounded-md bg-[#FFFAE7] p-4">
