    ...
    <div className="container mx-auto">
      <div className="flex justify-between items-start gap-2">
        <div
          className={
            menuIsOpen == -1
              ? "z-50 w-full md:w-72 bg-gray-600 md:bg-[#FFFAE7] p-6 rounded-none md:rounded-md md:bg-transparent fixed md:sticky md:top-8 md:right-0 md:bottom-8 h-auto py-2 md:py-4 md:px-2 top-0 bottom-0 left-[100%] md:left-0 -right-[100%] transition-all duration-500"
              : "z-50 w-full md:w-72 backdrop-blur-3xl md:bg-[#FFFAE7] p-6 rounded-none md:rounded-md md:bg-transparent h-[100vh] py-1 md:px-2 fixed top-0 bottom-0 right-0 left-0 md:absolute transition-all duration-500"
          }
        >
        ...
        <div className="p-2 md:p-4 bg-[#FFFAE7] w-full rounded-md mt-4 md:mt-0">
          {details}
        </div>
      </div>
