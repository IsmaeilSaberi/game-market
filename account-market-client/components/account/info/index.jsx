        ...
        {data[0] == -1 ? (
          ...
          <div className="flex flex-col gap-6">
            {data.userIsActive == false ? (
              <div className="flex flex-col gap-8 bg-[#FFDE00] w-full text-sm rounded-md p-8 my-8">
                <form
            ...
            <div className="flex justify-between items-center gap-6 flex-wrap">
              <div className="flex justify-center gap-4 items-center bg-[#FFDE00] w-full md:w-60 text-sm h-10 rounded-md p-1">
            ...
            <div className="flex flex-col gap-8 bg-[#FFDE00] w-full text-sm rounded-md p-4">
            ...
            <div className="flex flex-col items-center gap-8 bg-[#FFDE00] w-full text-sm rounded-md p-4">
              <div>به روز رسانی اطلاعات</div>
              <form
                onSubmit={handleSubmit(miniUpdater)}
                className="flex flex-col gap-6 m-8 w-full md:w-[30rem] bg-[#FFFAE7] rounded-md p-6"
              >
            ...
            <div className="flex flex-wrap justify-between items-center gap-8 bg-[#FFDE00] w-full text-sm rounded-md p-4">
